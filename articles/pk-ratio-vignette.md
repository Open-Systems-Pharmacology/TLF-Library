...
[`vignette("plot-configuration")`](https://www.open-systems-pharmacology.org/TLF-Library/articles/plot-configuration.md)
and
[`vignette("theme-maker")`](https://www.open-systems-pharmacology.org/TLF-Library/articles/theme-maker.md)).
