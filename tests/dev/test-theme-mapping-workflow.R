...
plotObject <- plotObject + 
  geom_errorbar(aes(x = mappedData$x, ymin=mappedData$ymin, ymax=mappedData$ymax, 
                color = mappedData$color,
                size = mappedData$size), show.legend = FALSE)
plotObject <- plotObject + geom_point(aes(x = mappedData$x, y=mappedData$y,
                 color = mappedData$color,
                 shape = mappedData$shape,
                 size = mappedData$size), show.legend = TRUE)
