...
In these cases, it is easy to overwrite the default functions by specifying either using an home made function or directly using predefined functions as suggested in section 2.2.
