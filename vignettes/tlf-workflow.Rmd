---
title: "Introduction to tlf workflows"
...
```{r workflow illustration, out.width="100%", include=TRUE, fig.align="center", echo=FALSE}
...
In a tidy format dataframe, each *measurement*, such as a simulation result or experimental observation, is described entirely in one row.
...
In the sequel, we will use a dataset derived from the `OSPSuiteR` package: `testData`.
...
```{r grouping using data.frame, results='asis'}
