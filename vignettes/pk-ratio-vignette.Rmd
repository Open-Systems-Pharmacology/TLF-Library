...
# pkRatioData
knitr::kable(head(pkRatioData), digits = 2)
```
...
groups <- GroupMapping$new(color = "Gender", shape = c("Dose", "Compound"))
dataMapping <- PKRatioDataMapping$new(x = "Age", y = "PKRatios", groupMapping = groups)


dataMapping$x
dataMapping$y
dataMapping$pkRatioLines
dataMapping$groupMapping$color
dataMapping$groupMapping$shape
```
...
pkRatioDataMapping <- PKRatioDataMapping$new(
  groupMapping = GroupMapping$new(color = "Gender",
