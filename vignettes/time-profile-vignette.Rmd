...
knitr::kable(head(groupingDataFrame))
...
knitr::kable(head(shortGroupingsDataFrame))
...
# Show results for all groupings:
knitr::kable(shortBinnedGroupingsDataFrame , row.names = FALSE)
