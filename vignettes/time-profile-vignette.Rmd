...
The suggested workflow for performing any kind of plot with the `tlf`-library is illustrated in the figure below and is as follows:

1. Gather the data to be plotted in the form of a [*tidy*](https://cran.r-project.org/web/packages/tidyr/vignettes/tidy-data.html) dataframe.
2. Pre-process the data using `AggregationSummary` and `Groupings` classes and their built-in functions
