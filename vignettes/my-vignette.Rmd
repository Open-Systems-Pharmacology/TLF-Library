...
vignette: >
  %\VignetteIndexEntry{PK Ratio Example}
...
dataMapping <- PKRatioDataMapping$new(groupings = list(color = "Gender"), shape = c("Dose", "Compound"))

dataMapping$x
dataMapping$y
dataMapping$groupings
```
...
```{r}
# TODO Update to make it work again => Make sure PlotConfiguration.R is updated.
...
#pkRatioDataMapping <- PKRatioDataMapping$new(grouping = list(color = c("Gender"), 
