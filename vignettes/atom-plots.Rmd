...
Among its optional inputs, `addErrorbar` proposes `capExtent` a numeric that defines the width of the extremities of the error bars (caps). The value corresponds to the ratio of the mean spacing between plotted error bars. For instance, a `capExtent` of `1` will fill the caps until the next error bar.
