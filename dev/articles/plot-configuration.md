...
| font$`color      |red      |grey20   |grey20 |grey20 |grey20  |
|font`$size | 12 | 10 | 10 | 10 | 8 |
| font$`angle      |0        |0        |0      |90     |0       |
|font`$align | center | center | center | center | left |
| font$`fontFace   |plain    |plain    |plain  |plain  |plain   |
|font`$fontFamily |  |  |  |  |  |
...
[`useMatlabTheme()`](https://www.open-systems-pharmacology.org/TLF-Library/dev/reference/useMatlabTheme.md)
