...
- Legend entries for fold distance lines can be plotted in
  [`plotObsVsPred()`](https://www.open-systems-pharmacology.org/TLF-Library/dev/reference/plotObsVsPred.md)([\#359](https://github.com/open-systems-pharmacology/tlf-library/issues/359))
...
- The default theme for all plots is the new
  [`useMinimalTheme()`](https://www.open-systems-pharmacology.org/TLF-Library/dev/reference/useMinimalTheme.md)
