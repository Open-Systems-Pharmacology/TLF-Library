...
R6 class defining the configuration of a `ggplot` object for tornado
plots
...
- `bar`:
  ...
  logical setting if tornado is uses a bar plot instead of regular
  points
...
- [`TornadoPlotConfiguration$new()`](#method-TornadoPlotConfiguration-new)

- [`TornadoPlotConfiguration$clone()`](#method-TornadoPlotConfiguration-clone)
