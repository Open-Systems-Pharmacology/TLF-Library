...
R6 class defining the configuration of a `ggplot` object for PK ratio
plots
...
- `defaultYScale`:
  ...
  Default yAxis scale value when creating a `PKRatioPlotConfiguration`
  object
...
- [`PKRatioPlotConfiguration$clone()`](#method-PKRatioPlotConfiguration-clone)
