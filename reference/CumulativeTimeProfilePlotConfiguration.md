...
R6 class defining the configuration of a `ggplot` object for cumulative
time profile plots
...
- `defaultExpand`:
  ...
  `CumulativeTimeProfilePlotConfiguration` object
...
- [`CumulativeTimeProfilePlotConfiguration$new()`](#method-CumulativeTimeProfilePlotConfiguration-new)

- [`CumulativeTimeProfilePlotConfiguration$clone()`](#method-CumulativeTimeProfilePlotConfiguration-clone)
